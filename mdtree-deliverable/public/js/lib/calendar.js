angular.module('ui.rCalendar', [])
    ...
    .directive('calendar', function () {
        return {
            restrict: 'EA',
            replace: true,
            templateUrl: '../partials/templates/calendar/calendar.html',
            scope: {
                calendarMode: '=',
                rangeChanged: '&',
                eventSelected: '&',
    ...
    .directive('monthview', ['dateFilter', function (dateFilter) {
        return {
            restrict: 'EA',
            replace: true,
            templateUrl: '../partials/templates/calendar/month.html',
            require: ['^calendar', '?^ngModel'],
            link: function (scope, element, attrs, ctrls) {
                var ctrl = ctrls[0],
                    ngModelCtrl = ctrls[1];
    ...
    .directive('weekview', ['dateFilter', '$timeout', function (dateFilter, $timeout) {
        return {
            restrict: 'EA',
            replace: true,
            templateUrl: '../partials/templates/calendar/week.html',
            require: '^calendar',
    ...
    .directive('dayview', ['dateFilter', '$timeout', function (dateFilter, $timeout) {
        return {
            restrict: 'EA',
            replace: true,
            templateUrl: '../partials/templates/calendar/day.html',
            require: '^calendar',
            link: function (scope, element, attrs, ctrl) {
                $timeout(function () {
                    updateScrollGutter();
